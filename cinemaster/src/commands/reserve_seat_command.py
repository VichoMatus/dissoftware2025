...
class ReserveSeatCommand:
    def __init__(self, client_id, id_funcion, seat_id,db):
    ...
    def execute(self):
        ...
        # Crear objeto Seat y Proxy (opcional, si lo usas en memoria)
        seat_obj = Seat(
        ...
        # Crear la reserva principal y guardar en BD
        ...
        # Crear la relación asiento-reserva
        ...
        # Precargar relaciones si es necesario
        _ = nueva_reserva.client
        _ = nueva_reserva.funcion
        if nueva_reserva.funcion:
            _ = nueva_reserva.funcion.pelicula

        return reserva_asiento  # O return nueva_reserva si prefieres trabajar con la reserva principal